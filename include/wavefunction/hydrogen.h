...
/// @brief Represents a pair of quantum numbers (n, l).
///
/// This lightweight value type encodes the principal quantum number `n`
/// and the orbital angular momentum quantum number `l`.
///
/// The class is intentionally minimal and constexpr-friendly so that
/// quantum states can be selected at compile time.
///
/// Physical meaning:
