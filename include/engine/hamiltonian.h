...
public:
	constexpr Potential() noexcept
		: m_Start(0.0), m_End(0.0), m_V0(0.0)
	{
	}

	constexpr Potential(double start, double end, double v0) noexcept
...
public:
	...
	constexpr Hamiltonian(const HamiltonConstants& constants, const Potential& potential) noexcept
	...
	constexpr Hamiltonian(const HamiltonConstants& constants) noexcept
		: Hamiltonian(constants, Potential())
	{
	}
};
